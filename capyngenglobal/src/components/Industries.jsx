...
import '../style.css'; 
import {
  BsBank, BsBroadcast, BsMortarboard, BsHeartPulse, BsFuelPump,
  BsTools, BsCart, BsImage, BsBoxSeam, BsLightning,
  BsCpu, BsController, BsBuilding, BsAirplane
} from 'react-icons/bs';
...
const Industries = () => {
  return (
    <section className="industries-section-back">
      <div className="py-5 px-3 px-md-5 industries-section">
        <Container>
          ...
          <Row>
            {industries.map((item, index) => (
              <Col xs={12} sm={6} key={index}>
                <div className="industry-item mb-3 d-flex align-items-center">
